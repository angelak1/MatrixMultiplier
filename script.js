...
function checkInput() {
  ...
  var compH2 = h2;
  //if the width of the first is not equal to the height of the second the matrices cannot be multiplied
  if (w1 != compH2){
  ...
  while (j<=h1){
  	while (i<=w1){
    	//create inputs for the values in the matrix i describes the height and j second the width
	//formats them into an i by j matrix format
	var id = "m" + j + i;
